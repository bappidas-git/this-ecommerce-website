...
export default function useAdminInventory(params) {
  ...
  const fetchData = useCallback(async (silent = false) => {
    ...
    try {
      const result = await adminInventoryService.list(params);
  ...
  return { items, meta, error, isLoading, refetch, setItems, patchLocal };
}
